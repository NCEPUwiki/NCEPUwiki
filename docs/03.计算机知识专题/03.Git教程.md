---
title: Git教程
description: Git 入门到协作教程：安装与配置、仓库与分支概念、远程仓库同步、常用命令和 GitHub 协作流程，适合新手及 Wiki 贡献者。
date: 2026-05-01
...
![git_config](https://img.ncepuinfo.cc/03/03/git_config.png)

## 基本概念

### 区域概述 / Synopsis of Area

![Synopsis_of_Area](https://img.ncepuinfo.cc/03/03/Synopsis_of_Area.png)
...
![git_status](https://img.ncepuinfo.cc/03/03/git_status.png)
...
![流程图1](https://img.ncepuinfo.cc/03/03/流程图1.png)
...
![流程图2](https://img.ncepuinfo.cc/03/03/流程图2.png)
...
# Windows可手动创建，不必输命令
```
![VscodeGitTest](https://img.ncepuinfo.cc/03/03/git_VscodeGitTest.png)

![Test.md](https://img.ncepuinfo.cc/03/03/git_Test.png)
...
![cd进入](https://img.ncepuinfo.cc/03/03/git_cd.png)
...
![git init](https://img.ncepuinfo.cc/03/03/git_init.png)

![git init after](https://img.ncepuinfo.cc/03/03/git_init_after.png)
...
![Git_clone_link](https://img.ncepuinfo.cc/03/03/git_clone_link.png)
...
![git clone](https://img.ncepuinfo.cc/03/03/git_clone.png)

完成后*NCEPUwiki*仓库就被克隆在了本地

![git clone done](https://img.ncepuinfo.cc/03/03/git_clone_done.png)

## 常见命令

此流程图展示了对repo进行修改的大致流程及命令，已经可以应对包括NCEPUwiki贡献的绝大部分场景。后文提到的更多的命令可以不了解。

![流程图3](https://img.ncepuinfo.cc/03/03/流程图3.png)
...
![git add](https://img.ncepuinfo.cc/03/03/git_add.png)

可以使用 ```git status``` 来查看当前工作区和暂存区的状态

![git status](https://img.ncepuinfo.cc/03/03/git_status.png)
...
![git commit](https://img.ncepuinfo.cc/03/03/git_commit.png)

使用 `git log` 查看提交记录

![git log](https://img.ncepuinfo.cc/03/03/git_log.png)
...
![git branch](https://img.ncepuinfo.cc/03/03/git_branch_new.png)

创建新分支之后可以发现我们仍然在主分支*master*上

![git branch after](https://img.ncepuinfo.cc/03/03/git_branch_new_after.png)
...
![git checkout](https://img.ncepuinfo.cc/03/03/git_checkout.png)
...
![git_rebase](https://img.ncepuinfo.cc/03/03/git_rebase.png)
...
![用Vscode打开文件夹](https://img.ncepuinfo.cc/03/03/vscode_open_dir.png)

在 VSCode 左边的活动栏中找到源代码管理选项。
点击初始化仓库来将当前目录纳入到git版本管理。
<br><br>

![使用Vscode来初始化本地Git仓库](https://img.ncepuinfo.cc/03/03/vscode_git_init_before.png)

点击初始化仓库后

![初始化之后的界面](https://img.ncepuinfo.cc/03/03/vscode_git_init_after.png)
...
![将文件添加至暂存区](https://img.ncepuinfo.cc/03/03/vscode_git_add.png)
...
![在资源管理器页面对文件进行修改](https://img.ncepuinfo.cc/03/03/vscode_git_modify_file.png)
...
![创建新分支](https://img.ncepuinfo.cc/03/03/vscode_branch_new.png)

点击 *+创建新分支...*,并输入新分支的名字可以创建一个新分支。

![两个分支](https://img.ncepuinfo.cc/03/03/vscode_branch_two_branch.png)
...
![添加远程库](https://img.ncepuinfo.cc/03/03/vscode_git_remote.png)

点击 *添加远程存储库...* 来添加一个远程仓库,仓库Url可以在仓库的Github中找到

![仓库Url](https://img.ncepuinfo.cc/03/03/vscode_git_remote_url.png)

*图示为NCEPUwiki Github仓库的Url*

配置好后就可以进行拉取推送操作了

![push OR pull](https://img.ncepuinfo.cc/03/03/vscode_git_pushorpull.png)
...
![git clone](https://img.ncepuinfo.cc/03/03/vscode_git_clone.png)
...
![fork](https://img.ncepuinfo.cc/03/03/git_fork.png)
...
![pull request](https://img.ncepuinfo.cc/03/03/git_pull_request.png)

![create pull request](https://img.ncepuinfo.cc/03/03/git_create_pull_request.png)
...
![new pull request](https://img.ncepuinfo.cc/03/03/pullrequest_new.png)

![create pull request](https://img.ncepuinfo.cc/03/03/pullrequest_create.png)
