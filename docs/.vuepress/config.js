...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ...
    ['meta', { name: 'description', content: 'NCEPUwiki(华北电力大学wiki)是华北电力大学校园知识库' }],
    ['meta', { name: 'keywords', content: 'ncepu,wiki,华北电力大学' }],
    ...
    ['meta', { name: 'google-site-verification', content: 'oW7CriR2uHHjqtMhZXLTmY-xc85xXlsnuOkOHX-CkPI' }],
  ],
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:1361942776@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/NCEPUwiki/NCEPUwiki'
        },
      ]
    },
    footer: { // 页脚信息
  ...
  plugins: [
    ...
    [
      ...
      {
        hm: baiduCode || '576b98a528986a66a53f2e7f08e1e757'
      }
    ],
